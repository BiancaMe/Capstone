...
function dynamicInter() {
  ...
  const interInfo ={inter1, inter2, inter3, inter4};
  ...
  for(let i in interInfo){
    ...
    const text2 = document.createTextNode(interInfo[i].name);
    ...
    const text3=document.createTextNode(interInfo[i].band);
    ...
    const text4=document.createTextNode(interInfo[i].text);
